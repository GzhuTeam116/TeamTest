...
public class Capture_Activcity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button_buy = (Button)findViewById(R.id.button_buy);
		 ...
		 String result = bundle.getString("result"); // 扫描的结果
		 ...
		 StringRequest stringRequest = new StringRequest(url,  
                new Response.Listener<String>() {  
                    	...
                    	try {
                    		...
                    		String book_url = c.getString("book_img");
                 	        ...
                 	        imageLoader.get( book_url, listener);
								...
								e.printStackTrace();
								Toast.makeText(Capture_Activcity.this, "系统出错",
                    ...
                    public void onErrorResponse(VolleyError error) {  
                        ...
                        Toast.makeText(Capture_Activcity.this, "网络连接错误",
								     Toast.LENGTH_SHORT).show();
